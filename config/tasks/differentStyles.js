...
const sassPaths = project.sourceDirectory + '/' + project.differentStylesDirectory +'/' + project.stylesDirectory + '/*.scss'
const autoprefixerSettings = targets.autoprefixer
const cssFileName = project.cssMinFileName
const dest = project.distDirectory + '/' + project.differentStylesDirectory + '/' + project.stylesDirectory
